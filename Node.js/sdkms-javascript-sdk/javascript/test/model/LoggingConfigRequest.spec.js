...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.LoggingConfigRequest();
  });
  ...
  describe('LoggingConfigRequest', function() {
    it('should create an instance of LoggingConfigRequest', function() {
      // uncomment below and update the code to test LoggingConfigRequest
      //var instane = new FortanixSdkmsRestApi.LoggingConfigRequest();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.LoggingConfigRequest);
    });
