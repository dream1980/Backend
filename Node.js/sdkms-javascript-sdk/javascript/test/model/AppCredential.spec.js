...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.AppCredential();
  });
  ...
  describe('AppCredential', function() {
    it('should create an instance of AppCredential', function() {
      // uncomment below and update the code to test AppCredential
      //var instane = new FortanixSdkmsRestApi.AppCredential();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.AppCredential);
    });
