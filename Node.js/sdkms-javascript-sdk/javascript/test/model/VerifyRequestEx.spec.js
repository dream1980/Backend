...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.VerifyRequestEx();
  });
  ...
  describe('VerifyRequestEx', function() {
    it('should create an instance of VerifyRequestEx', function() {
      // uncomment below and update the code to test VerifyRequestEx
      //var instane = new FortanixSdkmsRestApi.VerifyRequestEx();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.VerifyRequestEx);
    });
