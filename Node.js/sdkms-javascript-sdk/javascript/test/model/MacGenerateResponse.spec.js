...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.MacGenerateResponse();
  });
  ...
  describe('MacGenerateResponse', function() {
    it('should create an instance of MacGenerateResponse', function() {
      // uncomment below and update the code to test MacGenerateResponse
      //var instane = new FortanixSdkmsRestApi.MacGenerateResponse();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.MacGenerateResponse);
    });
