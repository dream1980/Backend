...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.PasswordChangeRequest();
  });
  ...
  describe('PasswordChangeRequest', function() {
    it('should create an instance of PasswordChangeRequest', function() {
      ...
      //var instane = new FortanixSdkmsRestApi.PasswordChangeRequest();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.PasswordChangeRequest);
    });
