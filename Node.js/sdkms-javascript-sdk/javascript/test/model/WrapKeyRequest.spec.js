...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.WrapKeyRequest();
  });
  ...
  describe('WrapKeyRequest', function() {
    it('should create an instance of WrapKeyRequest', function() {
      // uncomment below and update the code to test WrapKeyRequest
      //var instane = new FortanixSdkmsRestApi.WrapKeyRequest();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.WrapKeyRequest);
    });
