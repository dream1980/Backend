...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.PasswordResetRequest();
  });
  ...
  describe('PasswordResetRequest', function() {
    it('should create an instance of PasswordResetRequest', function() {
      ...
      //var instane = new FortanixSdkmsRestApi.PasswordResetRequest();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.PasswordResetRequest);
    });
