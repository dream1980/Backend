...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.GoogleServiceAccountKey();
  });
  ...
  describe('GoogleServiceAccountKey', function() {
    it('should create an instance of GoogleServiceAccountKey', function() {
      // uncomment below and update the code to test GoogleServiceAccountKey
      //var instane = new FortanixSdkmsRestApi.GoogleServiceAccountKey();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.GoogleServiceAccountKey);
    });
