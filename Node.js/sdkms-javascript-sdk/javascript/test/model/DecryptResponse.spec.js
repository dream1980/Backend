...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.DecryptResponse();
  });
  ...
  describe('DecryptResponse', function() {
    it('should create an instance of DecryptResponse', function() {
      ...
      //var instane = new FortanixSdkmsRestApi.DecryptResponse();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.DecryptResponse);
    });
