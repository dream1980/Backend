...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.MacVerifyRequest();
  });
  ...
  describe('MacVerifyRequest', function() {
    it('should create an instance of MacVerifyRequest', function() {
      ...
      //var instane = new FortanixSdkmsRestApi.MacVerifyRequest();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.MacVerifyRequest);
    });
