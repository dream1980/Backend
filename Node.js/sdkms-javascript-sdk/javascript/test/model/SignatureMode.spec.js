...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.SignatureMode();
  });
  ...
  describe('SignatureMode', function() {
    it('should create an instance of SignatureMode', function() {
      // uncomment below and update the code to test SignatureMode
      //var instane = new FortanixSdkmsRestApi.SignatureMode();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.SignatureMode);
    });
