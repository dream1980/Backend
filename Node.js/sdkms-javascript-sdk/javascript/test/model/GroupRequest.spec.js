...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.GroupRequest();
  });
  ...
  describe('GroupRequest', function() {
    it('should create an instance of GroupRequest', function() {
      ...
      //var instane = new FortanixSdkmsRestApi.GroupRequest();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.GroupRequest);
    });
