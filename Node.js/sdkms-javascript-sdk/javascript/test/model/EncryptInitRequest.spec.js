...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.EncryptInitRequest();
  });
  ...
  describe('EncryptInitRequest', function() {
    it('should create an instance of EncryptInitRequest', function() {
      // uncomment below and update the code to test EncryptInitRequest
      //var instane = new FortanixSdkmsRestApi.EncryptInitRequest();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.EncryptInitRequest);
    });
