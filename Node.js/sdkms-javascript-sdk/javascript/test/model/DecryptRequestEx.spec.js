...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.DecryptRequestEx();
  });
  ...
  describe('DecryptRequestEx', function() {
    it('should create an instance of DecryptRequestEx', function() {
      // uncomment below and update the code to test DecryptRequestEx
      //var instane = new FortanixSdkmsRestApi.DecryptRequestEx();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.DecryptRequestEx);
    });
