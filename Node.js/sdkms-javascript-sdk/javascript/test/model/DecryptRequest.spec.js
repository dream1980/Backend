...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.DecryptRequest();
  });
  ...
  describe('DecryptRequest', function() {
    it('should create an instance of DecryptRequest', function() {
      ...
      //var instane = new FortanixSdkmsRestApi.DecryptRequest();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.DecryptRequest);
    });
