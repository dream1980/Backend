...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.SignupRequest();
  });
  ...
  describe('SignupRequest', function() {
    it('should create an instance of SignupRequest', function() {
      ...
      //var instane = new FortanixSdkmsRestApi.SignupRequest();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.SignupRequest);
    });
    ...
    it('should have the property recaptchaResponse (base name: "recaptcha_response")', function() {
