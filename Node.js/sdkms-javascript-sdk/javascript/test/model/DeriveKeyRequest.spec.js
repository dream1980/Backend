...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.DeriveKeyRequest();
  });
  ...
  describe('DeriveKeyRequest', function() {
    it('should create an instance of DeriveKeyRequest', function() {
      // uncomment below and update the code to test DeriveKeyRequest
      //var instane = new FortanixSdkmsRestApi.DeriveKeyRequest();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.DeriveKeyRequest);
    });
