...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.UnwrapKeyRequest();
  });
  ...
  describe('UnwrapKeyRequest', function() {
    it('should create an instance of UnwrapKeyRequest', function() {
      // uncomment below and update the code to test UnwrapKeyRequest
      //var instane = new FortanixSdkmsRestApi.UnwrapKeyRequest();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.UnwrapKeyRequest);
    });
