...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.DecryptInitRequest();
  });
  ...
  describe('DecryptInitRequest', function() {
    it('should create an instance of DecryptInitRequest', function() {
      // uncomment below and update the code to test DecryptInitRequest
      //var instane = new FortanixSdkmsRestApi.DecryptInitRequest();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.DecryptInitRequest);
    });
