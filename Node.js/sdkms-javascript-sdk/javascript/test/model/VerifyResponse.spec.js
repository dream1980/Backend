...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.VerifyResponse();
  });
  ...
  describe('VerifyResponse', function() {
    it('should create an instance of VerifyResponse', function() {
      ...
      //var instane = new FortanixSdkmsRestApi.VerifyResponse();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.VerifyResponse);
    });
