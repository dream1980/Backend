...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.EncryptInitRequestEx();
  });
  ...
  describe('EncryptInitRequestEx', function() {
    it('should create an instance of EncryptInitRequestEx', function() {
      // uncomment below and update the code to test EncryptInitRequestEx
      //var instane = new FortanixSdkmsRestApi.EncryptInitRequestEx();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.EncryptInitRequestEx);
    });
