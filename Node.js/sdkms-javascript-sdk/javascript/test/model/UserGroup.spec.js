...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.UserGroup();
  });
  ...
  describe('UserGroup', function() {
    it('should create an instance of UserGroup', function() {
      ...
      //var instane = new FortanixSdkmsRestApi.UserGroup();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.UserGroup);
    });
    ...
    it('should have the property groupRole (base name: "group_role")', function() {
      // uncomment below and update the code to test the property groupRole
      //var instane = new FortanixSdkmsRestApi.UserGroup();
      //expect(instance).to.be();
    });
