...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.DecryptInitRequestEx();
  });
  ...
  describe('DecryptInitRequestEx', function() {
    it('should create an instance of DecryptInitRequestEx', function() {
      // uncomment below and update the code to test DecryptInitRequestEx
      //var instane = new FortanixSdkmsRestApi.DecryptInitRequestEx();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.DecryptInitRequestEx);
    });
