...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.MacVerifyRequestEx();
  });
  ...
  describe('MacVerifyRequestEx', function() {
    it('should create an instance of MacVerifyRequestEx', function() {
      // uncomment below and update the code to test MacVerifyRequestEx
      //var instane = new FortanixSdkmsRestApi.MacVerifyRequestEx();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.MacVerifyRequestEx);
    });
