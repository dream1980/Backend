...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.VerifyRequest();
  });
  ...
  describe('VerifyRequest', function() {
    it('should create an instance of VerifyRequest', function() {
      ...
      //var instane = new FortanixSdkmsRestApi.VerifyRequest();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.VerifyRequest);
    });
