...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.SignResponse();
  });
  ...
  describe('SignResponse', function() {
    it('should create an instance of SignResponse', function() {
      // uncomment below and update the code to test SignResponse
      //var instane = new FortanixSdkmsRestApi.SignResponse();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.SignResponse);
    });
