...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.EncryptRequest();
  });
  ...
  describe('EncryptRequest', function() {
    it('should create an instance of EncryptRequest', function() {
      ...
      //var instane = new FortanixSdkmsRestApi.EncryptRequest();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.EncryptRequest);
    });
