...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FortanixSdkmsRestApi.WrapKeyRequestEx();
  });
  ...
  describe('WrapKeyRequestEx', function() {
    it('should create an instance of WrapKeyRequestEx', function() {
      // uncomment below and update the code to test WrapKeyRequestEx
      //var instane = new FortanixSdkmsRestApi.WrapKeyRequestEx();
      //expect(instance).to.be.a(FortanixSdkmsRestApi.WrapKeyRequestEx);
    });
